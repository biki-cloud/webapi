...
// Confirmer サーバのリストを受け取り、実際に疎通確認をし、サーバが起動していればtrue, していなければfalseを返す
...
func GetAliveServers(servers []string, endPoint string, confirmer Confirmer) (aliveServers []string, err error) {
